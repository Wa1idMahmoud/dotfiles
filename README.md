...
```bash
bash -c "`curl -fsSL https://github.com/Wa1idMahmoud/dotfiles/main/remote-install.sh`"
```
...
```bash
git clone https://github.com/Wa1idMahmoud/dotfiles ~/.dotfiles
```
...
Running `make` with the Makefile is idempotent. 
...
To customise the dotfiles to your likings, fork it and [be the king of your castle!](https://www.webpro.nl/articles/getting-started-with-dotfiles)

## Credits

Many thanks to the [dotfiles community](https://dotfiles.github.io), and [webpro](https://github.com/webpro/dotfiles)
